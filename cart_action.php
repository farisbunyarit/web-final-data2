<?php
// الخطوة 1: بدء الجلسة (ضروري لتخزين السلة مؤقتاً)
session_start();

// الخطوة 2: تضمين ملف الاتصال بقاعدة البيانات (مطلوب لخطوة إنهاء الطلب لاحقاً)
// تأكد من ضبط المسار الصحيح بناءً على هيكل ملفاتك
